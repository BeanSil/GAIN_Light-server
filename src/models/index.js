...
export { sequelize, Sequelize, account, student, teacher, guest, board, board_comment, board_likability,board_com_likability, board_data, room, roomApply, req_song, pointReason, points };
